...
QueWhen you run the command ``git branch debugging``, the following will happen:stion 6
----------
...
not all files only code.py because .gitignore remove file has extension txt
...
git rebase master           : he will do " c4' " in master branch

git checkout master : the head go to master
git merge experiment branch experiment will merge with branch master in c5
